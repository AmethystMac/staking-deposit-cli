...
TestnetSetting = BaseChainSetting(
    NETWORK_NAME=TESTNET, GENESIS_FORK_VERSION=bytes.fromhex('12345678'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('30a329e0fa6776631ce59f9df3c085d9752a3ebe78e5a284fe34453681fb9b0e'))
